...
{
	// Visualization
	pcl::visualization::PCLVisualizer viewer ("KFPCS");
	...
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> cloud_target_color_h 
		(cloud_target_vizu,
		 bckgr_gray_level,
		 bckgr_gray_level,
		 bckgr_gray_level);
	viewer.addPointCloud (cloud_target_vizu, cloud_target_color_h, "cloud_source v1", v1 );
	viewer.addPointCloud (cloud_target_vizu, cloud_target_color_h, "cloud_source v2", v2);
	
	// target cloud is green
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> cloud_source_color_h (cloud_source_vizu, 20, 180, 20);
	viewer.addPointCloud (cloud_source_vizu, cloud_source_color_h, "cloud_target_v1", v1);
	...
	viewer.addText ("Black: cloud source\nRed: KFPCS aligned point cloud", 10, 15, 16, txt_gray_lvl, txt_gray_lvl, txt_gray_lvl, "icp_info_2", v2);	
	//~ std::stringstream ss;
	//~ ss << iterations;
